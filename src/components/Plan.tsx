        ...
        <div className="plan">
            <div className="container">
                <div className="block-title">
                    <h2>
                        Пошаговый <UnderlinedText>план</UnderlinedText>
                    </h2>
                </div>
